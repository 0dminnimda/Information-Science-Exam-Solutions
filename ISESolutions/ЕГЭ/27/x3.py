...
В данном случае есть три подходящие пары: (5, 3), (7, 15) и (12, 9). Пара (7, 14) не подходит, так как в ней второе число чётное. Чтобы удовлетворить требования, надо взять пары (5, 3), (7, 15) и (12, 9). Сумма бо́льших чисел в этом случае равна 32, сумма меньших равна 19. Общая сумма равна 51. В ответе надо указать число 51.
